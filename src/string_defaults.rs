...
var author$project$SvgControlPage$Spec = F3(
	function (title, rootControl, state) {
		return {rootControl: rootControl, state: state, title: title};
	});
var author$project$SvgButton$Model = F9(
	function (name, label, cid, rect, srect, pressed, sendaddr, textSvg, touchonly) {
		return {cid: cid, label: label, name: name, pressed: pressed, rect: rect, sendaddr: sendaddr, srect: srect, textSvg: textSvg, touchonly: touchonly};
	});
var author$project$SvgThings$SRect = F4(
	function (x, y, w, h) {
		return {h: h, w: w, x: x, y: y};
	});
var author$project$SvgTextSize$getTextWidth = F2(
	function (text, font) {
		return 0;
	});
...
var author$project$SvgThings$calcText = F5(
...
var author$project$SvgThings$computeFontScaling = F4(
	function (fw, fh, rw, rh) {
		var wr = rw / fw;
		var hr = rh / fh;
		return (_Utils_cmp(wr, hr) < 0) ? wr : hr;
	});
var author$project$SvgThings$calcTextSvg = F3(
	function (fontFam, textString, rect) {
		var w = A2(author$project$SvgTextSize$getTextWidth, textString, '20px ' + fontFam);
		var fs = A4(author$project$SvgThings$computeFontScaling, w, 20.0, rect.w, rect.h);
		return A5(author$project$SvgThings$calcText, fontFam, textString, w, fs, rect);
	});
var author$project$SvgThings$ff = 'sans-serif';
...
var author$project$SvgButton$init = F4(
	function (sendaddr, rect, cid, spec) {
		var ts = function () {
			var _n0 = spec.label;
			if (_n0.$ === 'Just') {
				var lbtext = _n0.a;
				return A3(author$project$SvgThings$calcTextSvg, author$project$SvgThings$ff, lbtext, rect);
			} else {
				return _List_Nil;
			}
		}();
...
var author$project$SvgThings$mekhr = F3(
	function (br, w, i) {
		return A4(author$project$SvgThings$Rect, br.x + (w * i), br.y, w, br.h);
	});
...
var author$project$SvgThings$mekhrp = F2(
	function (prect, _n0) {
		var x = _n0.a;
		var w = _n0.b;
		return A4(author$project$SvgThings$Rect, x, prect.y, w, prect.h);
	});
...
var author$project$SvgThings$hrectsp = F3(
	function (rct, count, props) {
		...
		var widths = A2(
			...
			pprops);
		var xes = A2(author$project$SvgThings$somme, rct.x, widths);
		return A2(
			elm$core$List$map,
...
var author$project$SvgThings$mekvr = F3(
	function (br, h, i) {
		return A4(author$project$SvgThings$Rect, br.x, br.y + (h * i), br.w, h);
	});
...
var author$project$SvgThings$mekvrp = F2(
	function (prect, _n0) {
		var y = _n0.a;
		var h = _n0.b;
		return A4(author$project$SvgThings$Rect, prect.x, y, prect.w, h);
	});
var author$project$SvgThings$vrectsp = F3(
	function (rct, count, props) {
		...
		var heights = A2(
			...
			pprops);
		var yes = A2(author$project$SvgThings$somme, rct.y, heights);
		return A2(
			elm$core$List$map,
...
var author$project$SvgLabel$Model = F6(
	function (name, label, cid, rect, srect, textSvg) {
		return {cid: cid, label: label, name: name, rect: rect, srect: srect, textSvg: textSvg};
	});
var author$project$SvgLabel$NoOp = {$: 'NoOp'};
var elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var author$project$SvgLabel$init = F3(
	function (rect, cid, spec) {
		var ts = A3(author$project$SvgThings$calcTextSvg, author$project$SvgThings$ff, spec.label, rect);
		return _Utils_Tuple2(
			A6(
					...
					return function (orientation) {
						return function (pressed) {
							return function (location) {
								return function (sendaddr) {
									return function (textSvg) {
										return function (touchonly) {
											return {cid: cid, label: label, location: location, name: name, orientation: orientation, pressed: pressed, rect: rect, sendaddr: sendaddr, srect: srect, textSvg: textSvg, touchonly: touchonly};
										};
									};
								};
							};
...
var author$project$SvgSlider$init = F4(
	function (sendaddr, rect, cid, spec) {
		var ts = function () {
			var _n0 = spec.label;
			if (_n0.$ === 'Just') {
		...
		return _Utils_Tuple2(
			author$project$SvgSlider$Model(spec.name)(
				A2(elm$core$Maybe$withDefault, '', spec.label))(cid)(rect)(
				A4(
					author$project$SvgThings$SRect,
					elm$core$String$fromInt(rect.x),
					elm$core$String$fromInt(rect.y),
					elm$core$String$fromInt(rect.w),
					elm$core$String$fromInt(rect.h)))(spec.orientation)(false)(0.5)(sendaddr)(ts)(false),
			elm$core$Platform$Cmd$none);
	});
var author$project$SvgThings$shrinkRect = F2(
	function (border, rect) {
		return A4(author$project$SvgThings$Rect, rect.x + border, rect.y + border, (rect.w - border) - border, (rect.h - border) - border);
	});
...
var author$project$SvgControl$init = F4(
	function (sendaddr, rect, cid, spec) {
		switch (spec.$) {
			case 'CsButton':
				var s = spec.a;
				...
				return _Utils_Tuple2(
					...
					A2(elm$core$Platform$Cmd$map, author$project$SvgControl$CaButton, b));
			case 'CsSlider':
				var s = spec.a;
				var _n4 = A4(
				...
				return _Utils_Tuple2(
					...
					A2(elm$core$Platform$Cmd$map, author$project$SvgControl$CaSlider, b));
			case 'CsLabel':
				var s = spec.a;
				var _n5 = A3(
				...
				var b = _n5.b;
				return _Utils_Tuple2(
					author$project$SvgControl$CmLabel(a),
					A2(elm$core$Platform$Cmd$map, author$project$SvgControl$CaLabel, b));
			default:
				var s = spec.a;
				var _n6 = A4(author$project$SvgControl$szinit, sendaddr, rect, cid, s);
				var a = _n6.a;
				var b = _n6.b;
				return _Utils_Tuple2(
					author$project$SvgControl$CmSizer(a),
					A2(elm$core$Platform$Cmd$map, author$project$SvgControl$CaSizer, b));
		}
	});
var author$project$SvgControl$szinit = F4(
	function (sendaddr, rect, cid, szspec) {
		...
		var blist = A2(
			...
			A4(
				...
				idxs));
		var controlz = A2(
			author$project$SvgControl$zip,
			idxs,
			A2(elm$core$List$map, elm$core$Tuple$first, blist));
		var fx = elm$core$Platform$Cmd$batch(
			A2(
				elm$core$List$map,
				function (_n0) {
					var i = _n0.a;
					...
					return A2(
						...
						author$project$SvgControl$SzCMsg(i),
						a);
				},
				A2(
					author$project$SvgControl$zip,
					idxs,
					A2(elm$core$List$map, elm$core$Tuple$second, blist))));
		return _Utils_Tuple2(
			A5(
...
var author$project$SvgButton$encodeUpdateMessage = function (um) {
	var outlist1 = _List_fromArray(
		[
			...
			_Utils_Tuple2(
			'controlId',
			author$project$SvgThings$encodeControlId(um.controlId))
		]);
	var outlist2 = function () {
		var _n1 = um.updateType;
		if (_n1.$ === 'Just') {
			var ut = _n1.a;
			return A2(
				elm$core$List$append,
	...
	function (model, ut) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					pressed: _Utils_eq(ut, author$project$SvgButton$Press)
				}),
			elm$core$Platform$Cmd$none);
	});
...
var author$project$SvgButton$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SvgPress':
				return A2(author$project$SvgButton$pressup, model, author$project$SvgButton$Press);
			case 'SvgUnpress':
				var _n1 = model.pressed;
				if (_n1) {
					return A2(author$project$SvgButton$pressup, model, author$project$SvgButton$Unpress);
				} else {
			...
			default:
				...
				if (_n7.$ === 'Nothing') {
					return model.pressed ? A2(author$project$SvgButton$pressup, model, author$project$SvgButton$Unpress) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					return (!model.pressed) ? A2(author$project$SvgButton$pressup, model, author$project$SvgButton$Press) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$SvgLabel$update = F2(
	function (msg, model) {
		if (msg.$ === 'SvgUpdate') {
			var um = msg.a;
			var tswk = A3(author$project$SvgThings$calcTextSvg, author$project$SvgThings$ff, um.label, model.rect);
			var ts = A2(
				elm$core$List$map,
				function (meh) {
					return A2(
...
var author$project$SvgSlider$updsend = F3(
	function (model, mbut, loc) {
		...
		if (_Utils_eq(model.location, bLoc) && _Utils_eq(model.pressed, prest)) {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			var um = A2(
				elm$json$Json$Encode$encode,
	...
	function (evt, rect) {
		...
		return elm$core$List$head(
			A2(
				...
				function (touch) {
					return A3(author$project$SvgThings$containsXY, rect, touch.x | 0, touch.y | 0);
				},
				touches));
	});
			...
			case 'SvgPress':
				...
				if (_n1.$ === 'Ok') {
					...
					return A3(
						...
						model,
						elm$core$Maybe$Just(author$project$SvgSlider$Press),
						l);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			...
			default:
				...
				if (_n11.$ === 'Nothing') {
					return model.pressed ? A3(
						...
						model,
						elm$core$Maybe$Just(author$project$SvgSlider$Unpress),
						model.location) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var touch = _n11.a;
			...
			switch (_n0.a.$) {
				...
				case 'CaLabel':
					if (_n0.b.$ === 'CmLabel') {
						var ms = _n0.a.a;
						var m = _n0.b.a;
						var _n3 = A2(author$project$SvgLabel$update, ms, m);
						var a = _n3.a;
						var b = _n3.b;
						return _Utils_Tuple2(
							author$project$SvgControl$CmLabel(a),
				...
				default:
					if (_n0.b.$ === 'CmSizer') {
						var ms = _n0.a.a;
						var m = _n0.b.a;
						var _n4 = A2(author$project$SvgControl$szupdate, ms, m);
						var a = _n4.a;
						var b = _n4.b;
						return _Utils_Tuple2(
							author$project$SvgControl$CmSizer(a),
...
var author$project$SvgControlPage$Model = F7(
	function (title, mahrect, srect, spec, control, sendaddr, windowSize) {
		return {control: control, mahrect: mahrect, sendaddr: sendaddr, spec: spec, srect: srect, title: title, windowSize: windowSize};
	});
...
var author$project$SvgControlPage$init = F3(
	function (sendaddr, rect, spec) {
		var _n0 = A4(author$project$SvgControl$init, sendaddr, rect, _List_Nil, spec.rootControl);
		var conmod = _n0.a;
		var conevt = _n0.b;
		var _n1 = A2(
...
var author$project$SvgControl$tupMap2 = F3(
	function (fa, fb, ab) {
		return _Utils_Tuple2(
			fa(ab.a),
			fb(ab.b));
	...
	function (model, rect) {
		switch (model.$) {
			case 'CmButton':
				var mod = model.a;
				return A3(
					author$project$SvgControl$tupMap2,
					author$project$SvgControl$CmButton,
					elm$core$Platform$Cmd$map(author$project$SvgControl$CaButton),
					A2(
			...
			case 'CmSlider':
				...
				return A3(
					...
					elm$core$Platform$Cmd$map(author$project$SvgControl$CaSlider),
					A2(
			...
			case 'CmLabel':
				...
				return A3(
					...
					elm$core$Platform$Cmd$map(author$project$SvgControl$CaLabel),
					A2(
			...
			default:
				...
				return A3(
					...
					elm$core$Platform$Cmd$map(author$project$SvgControl$CaSizer),
...
var author$project$SvgControl$szresize = F2(
	function (model, rect) {
		...
		var controls = A2(
			...
			ctlsNeffs);
		var effs = elm$core$Platform$Cmd$batch(
			A2(
				elm$core$List$map,
				function (_n0) {
					var i = _n0.a;
					...
					return A2(
						elm$core$Platform$Cmd$map,
						function (ef) {
							return A2(author$project$SvgControl$SzCMsg, i, ef);
						},
						efs);
				},
				ctlsNeffs));
...
var author$project$SvgButton$jsUpdateType = function (ut) {
	switch (ut) {
		case 'Press':
			return elm$json$Json$Decode$succeed(author$project$SvgButton$Press);
		case 'Unpress':
			return elm$json$Json$Decode$succeed(author$project$SvgButton$Unpress);
		default:
			return elm$json$Json$Decode$succeed(author$project$SvgButton$Unpress);
	}
};
...
var author$project$SvgSlider$jsUpdateType = function (ut) {
	switch (ut) {
		case 'Press':
			return elm$json$Json$Decode$succeed(author$project$SvgSlider$Press);
		case 'Unpress':
			return elm$json$Json$Decode$succeed(author$project$SvgSlider$Unpress);
		default:
			return elm$json$Json$Decode$succeed(author$project$SvgSlider$Unpress);
	}
};
...
var author$project$SvgLabel$jsSpec = A3(
	...
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'label', elm$json$Json$Decode$string));
var author$project$SvgThings$Horizontal = {$: 'Horizontal'};
var author$project$SvgThings$jsOrientation = function (o) {
	switch (o) {
		case 'vertical':
			return elm$json$Json$Decode$succeed(author$project$SvgThings$Vertical);
		case 'horizontal':
			return elm$json$Json$Decode$succeed(author$project$SvgThings$Horizontal);
		default:
			return elm$json$Json$Decode$succeed(author$project$SvgThings$Horizontal);
	}
};
...
throw 'Some top-level definitions from `SvgControl` are causing infinite recursion:\n\n  ┌─────┐\n  │    jsSpec\n  │     ↓\n  │    jsCs\n  │     ↓\n  │    jsSzSpec\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
var author$project$SvgControlPage$jsSpec = A4(
	elm$json$Json$Decode$map3,
	author$project$SvgControlPage$Spec,
			...
			switch (msg.$) {
				case 'JsonMsg':
					...
					if (_n1.$ === 'Ok') {
						if (_n1.a.$ === 'JmSpec') {
							var spec = _n1.a.a;
							return A3(author$project$SvgControlPage$init, model.sendaddr, model.mahrect, spec);
						} else {
							var jmact = _n1.a.a;
							var $temp$msg = jmact,
								$temp$model = model;
				...
				case 'CMsg':
					var act = msg.a;
					var wha = A2(author$project$SvgControl$update, act, model.control);
					var newmod = _Utils_update(
						model,
						{control: wha.a});
					return _Utils_Tuple2(
						newmod,
						A2(elm$core$Platform$Cmd$map, author$project$SvgControlPage$CMsg, wha.b));
				case 'Resize':
					var newSize = msg.a;
					var nr = A4(
					...
					var _n2 = A2(author$project$SvgControl$resize, model.control, nr);
					var ctrl = _n2.a;
					var cmds = _n2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								control: ctrl,
								mahrect: nr,
								srect: author$project$SvgThings$toSRect(nr),
								windowSize: newSize
							}),
						A2(elm$core$Platform$Cmd$map, author$project$SvgControlPage$CMsg, cmds));
				default:
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$SvgButton$NoOp = {$: 'NoOp'};
var author$project$SvgButton$SvgPress = {$: 'SvgPress'};
var author$project$SvgButton$SvgUnpress = {$: 'SvgUnpress'};
...
var author$project$SvgButton$pressedColor = function (pressed) {
	if (pressed) {
		return '#f000f0';
	} else {
		return '#60B5CC';
...
var author$project$SvgButton$view = function (model) {
	return A2(
		elm$svg$Svg$g,
		author$project$SvgButton$buildEvtHandlerList(model.touchonly),
		_List_fromArray(
			[
				A2(
				elm$svg$Svg$rect,
				_List_fromArray(
					[
						...
						'fill: ' + (author$project$SvgButton$pressedColor(model.pressed) + ';'))
					]),
				_List_Nil),
				A2(
				elm$virtual_dom$VirtualDom$map,
...
var author$project$SvgLabel$view = function (model) {
	var lbrect = A2(
		elm$svg$Svg$rect,
		_List_fromArray(
			[
				...
				elm$svg$Svg$Attributes$rx('15'),
				elm$svg$Svg$Attributes$ry('15'),
				elm$svg$Svg$Attributes$style('fill: #A1A1A1;')
			]),
		_List_Nil);
...
var author$project$SvgSlider$NoOp = {$: 'NoOp'};
...
var author$project$SvgSlider$pressedColor = function (pressed) {
	if (pressed) {
		return '#f000f0';
	} else {
		return '#60B5CC';
...
var author$project$SvgSlider$view = function (model) {
	var evtlist = author$project$SvgSlider$buildEvtHandlerList(model.touchonly);
	var _n0 = function () {
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$svg$Svg$Attributes$style('fill: #F1F1F1;')
					]),
				_List_Nil),
				A2(
				elm$svg$Svg$rect,
				_List_fromArray(
					[
						...
						elm$svg$Svg$Attributes$ry('2'),
						elm$svg$Svg$Attributes$style(
						'fill: ' + (author$project$SvgSlider$pressedColor(model.pressed) + ';'))
					]),
				_List_Nil),
				A2(
				elm$virtual_dom$VirtualDom$map,
...
var author$project$SvgControl$szview = function (model) {
	var controllst = elm$core$Dict$toList(model.controls);
	return A2(
		elm$svg$Svg$g,
		_List_Nil,
		A2(elm$core$List$map, author$project$SvgControl$viewSvgControls, controllst));
};
var author$project$SvgControl$view = function (model) {
	switch (model.$) {
		case 'CmButton':
			var m = model.a;
			return A2(
				elm$virtual_dom$VirtualDom$map,
				author$project$SvgControl$CaButton,
				author$project$SvgButton$view(m));
		case 'CmSlider':
			var m = model.a;
			return A2(
				elm$virtual_dom$VirtualDom$map,
				author$project$SvgControl$CaSlider,
				author$project$SvgSlider$view(m));
		case 'CmLabel':
			var m = model.a;
			return A2(
				elm$virtual_dom$VirtualDom$map,
				author$project$SvgControl$CaLabel,
				author$project$SvgLabel$view(m));
		default:
			var m = model.a;
			return A2(
				elm$virtual_dom$VirtualDom$map,
				author$project$SvgControl$CaSizer,
				author$project$SvgControl$szview(m));
	}
};
var author$project$SvgControl$viewSvgControls = function (_n0) {
	var id = _n0.a;
	var model = _n0.b;
	return A2(
		elm$virtual_dom$VirtualDom$map,
		author$project$SvgControl$SzCMsg(id),
		author$project$SvgControl$view(model));
};
var author$project$SvgControlPage$viewSvgControl = function (conmodel) {
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$SvgControlPage$viewSvgControl(model.control))
					]))
			]));
};
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		update: author$project$SvgControlPage$update,
		view: function (model) {
			return A2(
				...
				_List_fromArray(
					[
						author$project$SvgControlPage$view(model)
					]));
		}
	});
