			...
			_0: A2(
				_elm_lang$svg$Svg$text_,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fontFamily(fontFam),
							_1: {
								ctor: '::',
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg$text(lbtext),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		};
...
var _bburdette$oscpad$SvgThings$processProps = F2(
	function (controlcount, lst) {
		...
		var s = _elm_lang$core$List$sum(lst2);
		return A2(
			_elm_lang$core$List$map,
			function (x) {
				return x / s;
		...
		if (_p0.ctor === 'Nothing') {
			...
			if (_p1.ctor === 'Nothing') {
				...
				return {
					ctor: '::',
					_0: f,
					_1: A2(_bburdette$oscpad$SvgThings$somme, s, _p1._0)
				};
			}
		}
	});
...
var _bburdette$oscpad$SvgThings$hrects = F2(
	function (rct, count) {
		var idxs = A2(_elm_lang$core$List$range, 0, count - 1);
		var w = _elm_lang$core$Basics$round(
			_elm_lang$core$Basics$toFloat(rct.w) / _elm_lang$core$Basics$toFloat(count));
		return A2(
			_elm_lang$core$List$map,
...
var _bburdette$oscpad$SvgThings$hrectsp = F3(
	function (rct, count, props) {
		...
		var pprops = A2(_bburdette$oscpad$SvgThings$processProps, count, props);
		var widths = A2(
			_elm_lang$core$List$map,
			function (p) {
...
var _bburdette$oscpad$SvgThings$vrects = F2(
	function (rct, count) {
		...
		var h = _elm_lang$core$Basics$round(
			_elm_lang$core$Basics$toFloat(rct.h) / _elm_lang$core$Basics$toFloat(count));
		return A2(
			_elm_lang$core$List$map,
...
var _bburdette$oscpad$SvgTouch$extractTouches = function (evt) {
	...
	if (_p0.ctor === 'Ok') {
		var touchresults = A2(
			...
			A2(_elm_lang$core$List$range, 0, _p0._0 - 1));
		var touches = A3(
			_elm_lang$core$List$foldr,
			F2(
				function (rst, tl) {
...
var _bburdette$oscpad$SvgTouch$extractTouchDict = function (evt) {
	...
	if (_p3.ctor === 'Ok') {
		var touchresults = A2(
			...
			A2(_elm_lang$core$List$range, 0, _p3._0 - 1));
		var touches = A3(
			_elm_lang$core$List$foldr,
			F2(
				function (rst, tl) {
...
var _bburdette$oscpad$SvgButton$buildEvtHandlerList = function (touchonly) {
	var me = {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onMouseDown(_bburdette$oscpad$SvgButton$SvgPress),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onMouseUp(_bburdette$oscpad$SvgButton$SvgUnpress),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onMouseOut(_bburdette$oscpad$SvgButton$SvgUnpress),
				_1: {ctor: '[]'}
			}
		}
	};
	var te = {
		ctor: '::',
		_0: _bburdette$oscpad$SvgButton$onTouchStart,
		_1: {
			ctor: '::',
			_0: _bburdette$oscpad$SvgButton$onTouchEnd,
			_1: {
				ctor: '::',
				_0: _bburdette$oscpad$SvgButton$onTouchCancel,
				_1: {
					ctor: '::',
					_0: _bburdette$oscpad$SvgButton$onTouchLeave,
					_1: {
						ctor: '::',
						_0: _bburdette$oscpad$SvgButton$onTouchMove,
						_1: {ctor: '[]'}
					}
				}
			}
	...
	return A2(
		...
		_bburdette$oscpad$SvgButton$buildEvtHandlerList(model.touchonly),
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x(model.srect.x),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y(model.srect.y),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(model.srect.w),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$height(model.srect.h),
								_1: {
									ctor: '::',
...
var _bburdette$oscpad$SvgButton$jsUpdateMessage = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'controlId', _bburdette$oscpad$SvgThings$decodeControlId),
	_elm_lang$core$Json_Decode$maybe(
		A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _bburdette$oscpad$SvgSlider$getY = A2(_elm_lang$core$Json_Decode$field, 'clientY', _elm_lang$core$Json_Decode$int);
var _bburdette$oscpad$SvgSlider$getX = A2(_elm_lang$core$Json_Decode$field, 'clientX', _elm_lang$core$Json_Decode$int);
...
var _bburdette$oscpad$SvgSlider$jsSpec = A4(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'orientation', _elm_lang$core$Json_Decode$string)));
...
var _bburdette$oscpad$SvgSlider$buildEvtHandlerList = function (touchonly) {
	var me = {
		ctor: '::',
		_0: _bburdette$oscpad$SvgSlider$onMouseDown,
		_1: {
			ctor: '::',
			_0: _bburdette$oscpad$SvgSlider$onMouseUp,
			_1: {
				ctor: '::',
				_0: _bburdette$oscpad$SvgSlider$onMouseLeave,
				_1: {
					ctor: '::',
					_0: _bburdette$oscpad$SvgSlider$onMouseMove,
					_1: {ctor: '[]'}
				}
			}
		}
	...
	var te = {
		ctor: '::',
		_0: _bburdette$oscpad$SvgSlider$onTouchStart,
		_1: {
			ctor: '::',
			_0: _bburdette$oscpad$SvgSlider$onTouchEnd,
			_1: {
				ctor: '::',
				_0: _bburdette$oscpad$SvgSlider$onTouchCancel,
				_1: {
					ctor: '::',
					_0: _bburdette$oscpad$SvgSlider$onTouchLeave,
					_1: {
						ctor: '::',
						_0: _bburdette$oscpad$SvgSlider$onTouchMove,
						_1: {ctor: '[]'}
					}
				}
			}
		...
		evtlist,
		{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$style('fill: #F1F1F1;'),
											_1: {ctor: '[]'}
										}
									}
								}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x(sx),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y(sy),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width(sw),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$height(sh),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$rx('2'),
										_1: {
...
var _bburdette$oscpad$SvgSlider$jsUpdateMessage = A5(
	...
	_elm_lang$core$Json_Decode$maybe(
		A2(
			...
			A2(_elm_lang$core$Json_Decode$field, 'state', _elm_lang$core$Json_Decode$string))),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'location', _elm_lang$core$Json_Decode$float)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'label', _elm_lang$core$Json_Decode$string)));
...
var _bburdette$oscpad$SvgLabel$view = function (model) {
	var lbrect = A2(
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$style('fill: #A1A1A1;'),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		{ctor: '[]'});
	var svgl = {ctor: '::', _0: lbrect, _1: model.textSvg};
	return A2(
		_elm_lang$virtual_dom$VirtualDom$map,
		function (_p5) {
			return _bburdette$oscpad$SvgLabel$NoOp;
		...
		while (true) {
			...
			if (_p3.ctor === 'Nothing') {
				...
				if (_p4.ctor === 'Just') {
					...
					var _p5 = _elm_lang$core$List$tail(xs);
					if (_p5.ctor === 'Just') {
						var _v6 = f,
							_v7 = _p5._0;
						f = _v6;
...
var _bburdette$oscpad$SvgControl$tupMap2 = F3(
	function (fa, fb, ab) {
		return {
			ctor: '_Tuple2',
			_0: fa(
				_elm_lang$core$Tuple$first(ab)),
			_1: fb(
				_elm_lang$core$Tuple$second(ab))
		};
	});
var _bburdette$oscpad$SvgControl$controlName = function (mod) {
	...
	switch (_p7.ctor) {
		case 'CmButton':
			return _elm_lang$core$Maybe$Just(_p7._0.name);
		case 'CmSlider':
			return _elm_lang$core$Maybe$Just(_p7._0.name);
		case 'CmLabel':
			return _elm_lang$core$Maybe$Just(_p7._0.name);
...
var _bburdette$oscpad$SvgControl$findControl = F3(
	function (x, y, mod) {
		...
		switch (_p9.ctor) {
			case 'CmButton':
				return A3(_bburdette$oscpad$SvgThings$containsXY, _p9._0.rect, x, y) ? _elm_lang$core$Maybe$Just(mod) : _elm_lang$core$Maybe$Nothing;
			case 'CmSlider':
				return A3(_bburdette$oscpad$SvgThings$containsXY, _p9._0.rect, x, y) ? _elm_lang$core$Maybe$Just(mod) : _elm_lang$core$Maybe$Nothing;
			case 'CmLabel':
				return _elm_lang$core$Maybe$Nothing;
			default:
				return A3(_bburdette$oscpad$SvgControl$szFindControl, _p9._0, x, y);
		}
	});
...
var _bburdette$oscpad$SvgControl$toCtrlMsg = F2(
	function (id, msg) {
		var _p12 = _elm_lang$core$List$head(id);
...
var _bburdette$oscpad$SvgControl$jsUpdateMessage = A2(
	...
	A2(_elm_lang$core$Json_Decode$field, 'controlType', _elm_lang$core$Json_Decode$string));
var _bburdette$oscpad$SvgControl$szupdate = F2(
	function (msg, model) {
		var _p14 = msg;
		var _p16 = _p14._0;
		var bb = A2(_elm_lang$core$Dict$get, _p16, model.controls);
		var _p15 = bb;
		if (_p15.ctor === 'Just') {
			var wha = A2(_bburdette$oscpad$SvgControl$update, _p14._1, _p15._0);
			var updcontrols = A3(
				_elm_lang$core$Dict$insert,
				_p16,
				_elm_lang$core$Tuple$first(wha),
				model.controls);
			...
			return {
				...
				_1: A2(
					...
					_bburdette$oscpad$SvgControl$SzCMsg(_p16),
					_elm_lang$core$Tuple$second(wha))
			};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
...
var _bburdette$oscpad$SvgControl$update = F2(
	function (msg, model) {
		var _p17 = {ctor: '_Tuple2', _0: msg, _1: model};
		_v17_4:
		do {
			if (_p17.ctor === '_Tuple2') {
				switch (_p17._0.ctor) {
					case 'CaButton':
						if (_p17._1.ctor === 'CmButton') {
							var _p18 = A2(_bburdette$oscpad$SvgButton$update, _p17._0._0, _p17._1._0);
							var a = _p18._0;
							var b = _p18._1;
							return {
								ctor: '_Tuple2',
					...
					case 'CaSlider':
						if (_p17._1.ctor === 'CmSlider') {
							var _p19 = A2(_bburdette$oscpad$SvgSlider$update, _p17._0._0, _p17._1._0);
							var a = _p19._0;
							var b = _p19._1;
							return {
								ctor: '_Tuple2',
					...
					case 'CaLabel':
						if (_p17._1.ctor === 'CmLabel') {
							var _p20 = A2(_bburdette$oscpad$SvgLabel$update, _p17._0._0, _p17._1._0);
							var a = _p20._0;
							var b = _p20._1;
							return {
								ctor: '_Tuple2',
					...
					default:
						if (_p17._1.ctor === 'CmSizer') {
							var _p21 = A2(_bburdette$oscpad$SvgControl$szupdate, _p17._0._0, _p17._1._0);
							var a = _p21._0;
							var b = _p21._1;
							return {
								ctor: '_Tuple2',
	...
	function (msgs, model) {
		return A3(
			...
			F2(
				function (msg, _p22) {
					var _p23 = _p22;
					var _p24 = A2(_bburdette$oscpad$SvgControl$update, msg, _p23._0);
					var modnew = _p24._0;
					var cmd = _p24._1;
					return {
						ctor: '_Tuple2',
...
var _bburdette$oscpad$SvgControl$szresize = F2(
	function (model, rect) {
		...
		var ctlsNeffs = A2(
			...
			function (_p25) {
				...
				return {
					ctor: '_Tuple2',
					_0: _p26._0._0,
					_1: A2(_bburdette$oscpad$SvgControl$resize, _p26._0._1, _p26._1)
				};
			},
		...
		var controls = A2(
			...
			function (_p27) {
				var _p28 = _p27;
				return {ctor: '_Tuple2', _0: _p28._0, _1: _p28._1._0};
			},
			ctlsNeffs);
			...
			A2(
				...
				function (_p29) {
					...
					return A2(
						_elm_lang$core$Platform_Cmd$map,
						function (ef) {
							return A2(_bburdette$oscpad$SvgControl$SzCMsg, _p30._0, ef);
						},
						_p30._1._1);
				},
				ctlsNeffs));
		...
		switch (_p31.ctor) {
			...
			default:
				return A3(
					...
					A2(_bburdette$oscpad$SvgControl$szresize, _p31._0, rect));
		}
	});
var _bburdette$oscpad$SvgControl$szinit = F4(
	function (sendaddr, rect, cid, szspec) {
		...
		var controlz = A2(
			...
			idxs,
			A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, blist));
		var fx = _elm_lang$core$Platform_Cmd$batch(
			A2(
				...
				function (_p34) {
					...
					return A2(
						_elm_lang$core$Platform_Cmd$map,
						_bburdette$oscpad$SvgControl$SzCMsg(_p35._0),
						_p35._1);
				},
				A2(
					_bburdette$oscpad$SvgControl$zip,
					idxs,
					A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, blist))));
		return {
			ctor: '_Tuple2',
			_0: A5(
...
var _bburdette$oscpad$SvgControl$init = F4(
	function (sendaddr, rect, cid, spec) {
		...
		switch (_p36.ctor) {
			...
			default:
				var _p40 = A4(_bburdette$oscpad$SvgControl$szinit, sendaddr, rect, cid, _p36._0);
				var a = _p40._0;
				var b = _p40._1;
				return {
					ctor: '_Tuple2',
...
var _bburdette$oscpad$SvgControl$viewSvgControls = function (_p41) {
	var _p42 = _p41;
	return A2(
		_elm_lang$virtual_dom$VirtualDom$map,
		_bburdette$oscpad$SvgControl$SzCMsg(_p42._0),
		_bburdette$oscpad$SvgControl$view(_p42._1));
};
	...
	switch (_p43.ctor) {
		case 'CmButton':
			return A2(
				_elm_lang$virtual_dom$VirtualDom$map,
				_bburdette$oscpad$SvgControl$CaButton,
				_bburdette$oscpad$SvgButton$view(_p43._0));
		case 'CmSlider':
			return A2(
				_elm_lang$virtual_dom$VirtualDom$map,
				_bburdette$oscpad$SvgControl$CaSlider,
				_bburdette$oscpad$SvgSlider$view(_p43._0));
		case 'CmLabel':
			return A2(
				_elm_lang$virtual_dom$VirtualDom$map,
				_bburdette$oscpad$SvgControl$CaLabel,
				_bburdette$oscpad$SvgLabel$view(_p43._0));
		default:
			return A2(
				_elm_lang$virtual_dom$VirtualDom$map,
				_bburdette$oscpad$SvgControl$CaSizer,
				_bburdette$oscpad$SvgControl$szview(_p43._0));
	}
};
...
var _bburdette$oscpad$SvgControlPage$jsSpec = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'rootControl', _bburdette$oscpad$SvgControl$jsSpec),
	_elm_lang$core$Json_Decode$maybe(
		A2(
			_elm_lang$core$Json_Decode$field,
			'state',
			...
			switch (_p2.ctor) {
				...
				case 'CMsg':
					...
					var newmod = _elm_lang$core$Native_Utils.update(
						model,
						{
							control: _elm_lang$core$Tuple$first(wha)
						});
					return {
						ctor: '_Tuple2',
						_0: newmod,
...
var _bburdette$oscpad$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		...
		subscriptions: function (model) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: A2(_elm_lang$websocket$WebSocket$listen, model.sendaddr, _bburdette$oscpad$SvgControlPage$JsonMsg),
					_1: {
						ctor: '::',
						_0: _elm_lang$window$Window$resizes(_bburdette$oscpad$SvgControlPage$Resize),
						_1: {ctor: '[]'}
					}
				});
		}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _bburdette$oscpad$Main$main !== 'undefined') {
    _bburdette$oscpad$Main$main(Elm['Main'], 'Main', undefined);
}
